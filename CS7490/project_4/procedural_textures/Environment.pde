  ...
  */
  class Environment {
    ...
    void addLight( Light _light ) {
      if( _light.getType() == sPointLight ) {
        mLights[mNumLights] = _light;
      }
      else if( _light.getType() == sDiskLight ) {
        mLights[mNumLights] = (DiskLight)_light;
      }
    ...
    void addNamedPrimitive( Primitive _primitive, String _name ) {
      ...
      if( _primitive.getType() == sSphereType ) {
        gNamedPrimitives[gNumNamedPrimitives] = (Sphere)_primitive;        
      } 
      else if( _primitive.getType() == sTriangleType ) {
        gNamedPrimitives[gNumNamedPrimitives] = (Triangle)_primitive;        
      } 
